...
pipObj.plotter.plot_weekly_view(plotting_df, "testC4003601")
...
pickleT = "--- Pickle savetime: {} seconds --- SIZE: {}KB".format(time.time() - start_time, os.path.getsize("../data/output/{}.pkl".format(name)) / 1024)
print(pickleT)
...
featherT = "--- Feather savetime: {} seconds --- SIZE: {}KB".format(time.time() - start_time, os.path.getsize("../data/output/{}.feather".format(name)) / 1024)
print(featherT)
